...
function askName() {
    var playerName;
    var selection = prompt("Please enter your character name:");
...
function newCard(deck, hand, discarded) {
    ...
    var top_of_deck = Number(deck.length - 1);
    var draw = deck[top_of_deck];
    ...
    newImage.addEventListener("click", function (e) {
        ...
        //splice, destructive
        var index = hand.findIndex(function (c) {
